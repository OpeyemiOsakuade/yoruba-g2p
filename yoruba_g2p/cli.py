...
#     try:
#         from .core import YorubaG2P
#         print("[DEBUG] Imported YorubaG2P successfully")
#     except Exception as e:
#         print("[IMPORT ERROR] Failed to import YorubaG2P:")
#         traceback.print_exc()
#         raise e
...
#     parser.add_argument("--out-dir", default="yoruba_g2p_out")

#     args = parser.parse_args()

#     print("[DEBUG] Running build_all_from_labs...")
#     g2p = YorubaG2P()
#     result = g2p.build_all_from_labs(args.lab_root, splits=args.splits, out_dir=args.out_dir)

#     print("[DEBUG] Completed. Output:")
#     print(result)
